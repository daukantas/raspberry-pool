...
const changeConfig = exports.changeConfig = (raspberry, newConfig) => {
  ...
  _assert(newConfig, _types.RaspberryConfigType, 'newConfig');

  return (() => {
    var _ref = _asyncToGenerator(function* (dispatch, _ref2) {
      let websocket = _ref2.websocket;

      _assert(dispatch, _tcombForked2.default.Function, 'dispatch');
...
function sendAction(raspberries, action) {
  _assert(raspberries, _tcombForked2.default.list(_types.RaspberryType), 'raspberries');
